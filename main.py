...
def make_predictions(input_df, input_dict):
  ...
  with col1:
    ...
    st.write(f"The customer has a {avg_probabilities:.2%} of churning.")
...
if selected_customer_option:
  ...
  explanation = explain_prediction(avg_probabilities, input_dict,
                                   selected_customer['Surname'])
  st.markdown("---")
  st.subheader("Explanation of Prediction")
  st.markdown(explanation)

  email = generate_email(avg_probabilities, input_dict, explanation,
                         selected_customer['Surname'])
  st.markdown("---")
